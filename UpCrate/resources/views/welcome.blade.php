...
<div>
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal" style="color: white">About</h1>
    <p class="lead font-weight-normal" style="color: white">Welcome to our file storage system, UpCrate. An efficient, creative service for file storage with a focus on sharing. We built this tool for file upload and storage, both public and private.</p>
    <br>
    <p class="lead font-weight-normal" style="color: white">We chose to use a radial menu for our homepage to keep every interaction easily reachable. Take time to mouse over each category, and know that some categories will reveal more information as they are clicked.</p>
    <br>
    <p class="lead font-weight-normal" style="color: white">This project was made by Jake Redmond, Nick Bigger, Rachel Gilligan and Thavy Thach. 2018.</p>
  </div>
