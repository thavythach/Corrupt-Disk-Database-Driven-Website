...
@section('content')
  ...
  <form action="/process" enctype="multipart/form-data" method="POST">
    ...
    <div id="userSelect"class="form-row" style="visibility:hidden">
      <div class="form-group col-md-4">
        <label for="userSelect">Select users that can access: </label>
        <select multiple class="form-control" id="exampleFormControlSelect2">
          <option>Jake Redmond</option>
          <option>Thavy Thach</option>
          <option>David Chiu</option>
          <option>Adrian Brody</option>
